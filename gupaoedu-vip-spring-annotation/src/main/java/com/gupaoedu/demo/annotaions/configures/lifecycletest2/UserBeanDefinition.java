...
public class UserBeanDefinition implements BeanFactoryAware, BeanNameAware,
    ...
    public void setBeanFactory(BeanFactory arg0) throws BeansException {
        System.out
                .println("【BeanFactoryAware接口】调用BeanFactoryAware.setBeanFactory():" + this.toString());
    ...
    public void afterPropertiesSet() throws Exception {
        System.out
                .println("【InitializingBean接口】调用InitializingBean.afterPropertiesSet()" + this.toString());
    }
