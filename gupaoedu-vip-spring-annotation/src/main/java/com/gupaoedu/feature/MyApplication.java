...
public class MyApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("getBean:(myFactoryBean) has man():" + applicationContext.getBean("myFactoryBean"));
        //true 多次获取都是同一个对象
        System.out.println("getBean:(myFactoryBean)" + applicationContext.getBean("myFactoryBean") == applicationContext.getBean("myFactoryBean"));
        //获取实际的工厂对象
